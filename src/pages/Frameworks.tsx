...
const LIBRARY = [
  ...
  { t: "The Pyramid Framework", d: "The signature AI adoption methodology: installation, integration, governance, evolution. 90 to 95% adoption against a 25% industry standard." },
